...
/**
 * Servlet implementation class SortCustomerDetailsController
 */
@WebServlet("/SortCustomerDetailsController")
public class SortCustomerDetailsController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SortCustomerDetailsController() {
        super();
