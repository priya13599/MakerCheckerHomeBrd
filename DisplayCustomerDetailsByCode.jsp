...
<div class="wrapper fadeInDown">
 ...
 <div id="formFooter"  style="background-color:#e3f2fd; color:#5fbae9">
    ...
    <form action="DisplayCustomerDetailsController" method="post">
      <input type="text" id="login" class="fadeIn second" name="customercode" placeholder="Customer Code" required>
      
      <br>
      <br>
      
      
      <input type="submit" class="fadeIn fourth" name ="display" value="DisplayDetails">
      </form>
      </div>
</div>
<%
